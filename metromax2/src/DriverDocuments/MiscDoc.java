...
public class MiscDoc {
	...
	public void startReport() {
		extent = new ExtentReports(System.getProperty("user.dir") + "/TestReports/UploadMiscellaneousDoc.html", true);
    ...
    public void EnterDocInformation() throws Throwable
    {
		...
		driver.findElement(SelectDocTypeMisc).click();
    ...
    @Test(priority=8, groups = "UploadMisc")
    public void MCInfoAndDoc() throws Throwable
    {
		...
		String Misc=props.getProperty("MiscDoc");
		String Desc=props.getProperty("Description");
		
		logger = extent.startTest("Enter the Misc Details and Upload Doc");
		driver.findElement(UploadDLFront).sendKeys(Misc);
  ...
  //  @Test(priority=10, groups = "Submit")
    ...
    {
    	logger = extent.startTest("Submit the Misc Details");
