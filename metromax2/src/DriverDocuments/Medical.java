...
public class Medical {
	...
	public void startReport() {
		extent = new ExtentReports(System.getProperty("user.dir") + "/TestReports/UploadMedicalCertificate.html", true);
    ...
    public void EnterDocInformation() throws Throwable
    {
    	...
    	logger = extent.startTest("Enter the Driver MC Details");

		driver.findElement(ClickDocType).click();
		driver.findElement(SelectDocTypeMC).click();
    ...
    {
    	logger = extent.startTest("Enter the MC Issue Date and Exp Date");
    ...
    @Test(priority=8, groups = "UploadMVR")
    public void MCInfoAndDoc() throws Throwable
    {
		...
		String RegN=props.getProperty("RegNum");
		String DrName=props.getProperty("DoctorName");
		String MCDoc=props.getProperty("MCDoc");
		String NRCMEDoc=props.getProperty("NRCMEDoc");
		
		logger = extent.startTest("Enter the MC Details and Upload Doc");
		driver.findElement(RegNo).sendKeys(RegN);
		driver.findElement(DoctorName).sendKeys(DrName);
		driver.findElement(UploadMedicalCertificate).sendKeys(MCDoc);
    ...
    {
    	logger = extent.startTest("Submit the MC Details");
