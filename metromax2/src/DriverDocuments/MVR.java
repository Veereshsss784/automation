...
public class MVR {
	...
	public void startReport() {
		extent = new ExtentReports(System.getProperty("user.dir") + "/TestReports/UploadMVR.html", true);
    ...
    {
    	logger = extent.startTest("Enter the MVR Issue Date and Exp Date");
    ...
    public void UploadtheDLFrontAndBackDoc() throws Throwable
    {
		...
		String MVR=props.getProperty("MVRDoc");
		
		logger = extent.startTest("Enter the MVR Details");
		driver.findElement(UploadDLFront).sendKeys(MVR);
		Assert.assertTrue(true);
		logger.log(LogStatus.PASS, "Test Case Passed ");
    }
