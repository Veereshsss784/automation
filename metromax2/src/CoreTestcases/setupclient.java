...
public class setupclient {
		...
		By Setup_client=By.xpath("//a[@class='form_wizard_width tabstyling1 tbw1 nav-item nav-link']"); //By.xpath("//a[@id='manageclient.salespersonsetup']");
...
//		Please Choose Any one Option CDL Packages and Non Non CDL Packages 
	...
	//-------------------------------------------------------------------------------------------------------------------------------
		...
		//	System.out.println(driver.findElement(Client_list).getText());
			...
			driver.findElement(CompEmail).sendKeys("Company"+generateChar1()+"@innowyze.testinator.com");
			...
			driver.findElement(FirstName).sendKeys("VCarrier"+generateChar());
			...
			driver.findElement(LastName).sendKeys("Lastname"+generateChar());
		    System.out.println(generateChar());
		    driver.findElement(PhoneNumber).sendKeys("4042"+getRandomNumberString());
		    driver.findElement(Emailaddrs).sendKeys("Veereshtestit@gmail.com");
