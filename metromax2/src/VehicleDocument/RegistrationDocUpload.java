...
public class RegistrationDocUpload {
	...
	By VehicleReg = By.xpath("//li[normalize-space()='Vehicle Registration']");
	// By.xpath("//div[@role='dialog']")
	// By.xpath("//div[@role='dialog']")
	By RegNum = By.xpath("//input[@id='registrationNumber']");
	By issueDate = By.xpath("//input[@id='issueDate']");
	By ExpDate = By.xpath("//input[@id='expirationDate']");
	By UploadRegDoc = By.xpath("//input[@id='document']");
	By UnitNumber = By.xpath(
			"//div[@name='vehicle']//button[@title='Open']//span[@class='MuiIconButton-label']//*[name()='svg']");
	...
	public void startReport() {
		extent = new ExtentReports(System.getProperty("user.dir") + "/TestReports/UploadVehicleRegDoc.html", true);
    ...
    public void EnterVehicleRegInformation() throws Throwable
    {
		Properties props = new Properties();
		...
		String VReg=props.getProperty("RegNum");
		String UploadLease=props.getProperty("UploadRegDoc");
    
    	logger = extent.startTest("Enter the Vehicle Registration Details");
    	driver.findElement(DocType).click();
    	Thread.sleep(1000);
    	driver.findElement(VehicleReg).click();
    	driver.findElement(RegNum).sendKeys(VReg);
    	Assert.assertTrue(true);
		logger.log(LogStatus.PASS, "Test Case Passed ");
    }
    ...
    {
    	logger = extent.startTest("Enter the Driver vehicle Details");
   ...
   public void UploadtheMVRDoc() throws Throwable
    {
		...
		String UpRegDoc=props.getProperty("UploadRegDoc");
		
		logger = extent.startTest("Enter the MVR Details");
		driver.findElement(UploadRegDoc).sendKeys(UpRegDoc);
		Assert.assertTrue(true);
		logger.log(LogStatus.PASS, "Test Case Passed ");
    }
