...
public class LeaseDocUpload {
	...
	public void startReport() {
		extent = new ExtentReports(System.getProperty("user.dir") + "/TestReports/UploadVehicleLeaseDoc.html", true);
    ...
    public void EnterMVRInformation() throws Throwable
    {
		...
		String LeaseDocNo=props.getProperty("LeaseDocNumber");
    	...
    	driver.findElement(LeaseDocNum).sendKeys(LeaseDocNo);
    	driver.findElement(LeaseCompanyName).sendKeys(LeaseCompany);
    ...
    public void EnterIssueAndExpDate()
    {
		...
		driver.findElement(ExpirationDate).sendKeys(ExpDateAfter2Months());
		Assert.assertTrue(true);
		logger.log(LogStatus.PASS, "Test Case Passed ");
    }
	 @Test(priority=8, groups = "UploadVehicleLease")
   public void UploadtheMVRDoc() throws Throwable
    {
		...
		driver.findElement(UploadLeaseDoc).sendKeys(UploadLease);
		Assert.assertTrue(true);
		logger.log(LogStatus.PASS, "Test Case Passed ");
    }
