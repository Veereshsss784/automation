package DriverDocument;
	...
	public class MVRDocUpload {
		...
		By UploadMVRDoc=By.xpath("//input[@id='document']");
		...
		public void startReport() {
			extent = new ExtentReports(System.getProperty("user.dir") + "/TestReports/UploadDriverMVRDoc.html", true);
	    ...
	    public void EnterMVRInformation() throws Throwable
	    {
			...
			driver.findElement(SelectDocTypeMVR).click();
	   ...
	   @Test(priority=8, groups = "UploadMVR")
	    public void UploadtheMVRDoc() throws Throwable
	    {
			...
			String UploadMVR=props.getProperty("MVRDoc");
			
			logger = extent.startTest("Enter the MVR Details");
			driver.findElement(UploadMVRDoc).sendKeys(UploadMVR);
			Assert.assertTrue(true);
			logger.log(LogStatus.PASS, "Test Case Passed ");
	    }
