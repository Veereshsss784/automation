...
public class SubmitDriverApplicationYesReport 
{
...
//-------------------------------------------------------------------------------------------------------------------------    
	...
	public void startReport() {
		extent = new ExtentReports(System.getProperty("user.dir") + "/TestReports/DriverApplicationAllYes.html", true);
...
//---------------------------------------------------------------------------------------------------------------------------------	
	...
	String DriverDev="https://dev.fleetdrive360.com/apply";
...
//Driver application Login	
	@Test(priority=1)
	public void Verify_Driver_login() throws InterruptedException, AWTException
	{
		...
		//driver.get(DriverDev);
		driver.get("https://dev.fleetdrive360.com/login-check?token=f6c10d5440d814401b2770bc5f3f83a");
		...
		logger.log(LogStatus.PASS, "Test Case1 Opened Driver Login Page and Minimized");
...
/*	@Test(priority=2)
	public void Verify_DriverUN()
	{
		...
		driver.findElement(DrUN).sendKeys("driverb4salaga76"); //=====================================================Username
	...
	public void Verify_DriverPSWD()
	{
		...
		String title1 = driver.getTitle();
		System.out.println(title1);
		driver.findElement(DrPSWD).sendKeys("@3ze2Z#EbX");  //==================================================Password
		Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
...
*/
	...
	logger = extent.startTest("Fill Driver Basic info");
		String title1 = driver.getTitle();
		System.out.println(title1);
		driver.findElement(DrDOB).sendKeys("01021980");
...
//	Form 2. Driver Address History
	...
	@Test(priority=12)
	public void Verify_Select_State() throws InterruptedException
	{
...
*/
	...
	logger = extent.startTest("Enter DL Issue Date");
		...
		driver.findElement(DL_IssueDate).sendKeys("01022014");	
		Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
	...
	logger = extent.startTest("Enter DL Exp Date");
		String title1 = driver.getTitle();
		driver.findElement(DL_ExpDate).sendKeys("01022026");	
		Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
...
// Form 4.Commercial Driving and Equipment Experience
	...
	logger = extent.startTest("Enter From_Date");
		String title1 = driver.getTitle();
		driver.findElement(By.xpath("//input[@name='form.equipment.0.operatedFrom']")).sendKeys("01022015");
	...
	logger = extent.startTest("Enter ToDate");
		String title1 = driver.getTitle();
		driver.findElement(By.xpath("//input[@name='form.equipment.0.operatedTo']")).sendKeys("01022020");
...
/*	@Test(priority=30)
   public void HaveCemmercialDrivingExpNo()
	...
	logger = extent.startTest("Enter DriverEmplrInfo");
		...
		Thread.sleep(2000);
		driver.findElement(ReasonForLeaving).sendKeys("Reason For Leaving"+Address());
		Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
	...
	public void JoiningFromDate() throws InterruptedException
	{
		...
		String title1 = driver.getTitle();
		driver.findElement(ClickFromDate).sendKeys("01022016");
	...
	public void ResignedDate() throws InterruptedException
	{
		...
		String title1 = driver.getTitle();
		driver.findElement(ClickToDate).sendKeys("01022021");
	...
	public void EmplrEmail() throws InterruptedException
	{
		...
		String title1 = driver.getTitle();
		driver.findElement(EmplrEmail).sendKeys("Emplyr"+RandomChar()+"@metrotms.testinator.com");
		Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
...
// Form 6.Traffic Violations
 ...
 /*  public void Traffic_ViolationNo() throws InterruptedException
	...
	@Test(priority=41)
    public void TrafficViolations_Location() throws InterruptedException
    {
    ...
    logger = extent.startTest("Enter Traffic ViolationDate");
		String title1 = driver.getTitle();
    	driver.findElement(ClickDate).sendKeys("01021980");
   Thread.sleep(1000);
   Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
...
//Form 8.Accident History
	...
	logger = extent.startTest("Enter Restrictions");
		...
		driver.findElement(Click_AccidentDate).sendKeys("01022017");
...
//	Form 9. DOT Physical and Medical Certificate
	...
	public void MedicalCertificateIssueDate() throws InterruptedException
	{
		...
		String title1 = driver.getTitle();
		Thread.sleep(2000);
		driver.findElement(MedicalC_issuedateClick).sendKeys("12022022");
	...
	@Test(priority=54)
	public void MedicalCertificateExpDate() throws InterruptedException
	{
		Thread.sleep(4000);
	    logger = extent.startTest("Enter Medical Certificate ExpDate");
		String title1 = driver.getTitle();
		Thread.sleep(2000);
		driver.findElement(MedicalC_ExpDateClick).sendKeys("12022023");
	...
	logger = extent.startTest("Enter Name Of Medical Examiner");
		String title1 = driver.getTitle();
		driver.findElement(NameOfExaminar).sendKeys("Medical Examinar name-"+RandomChar());
		Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
	...
	logger = extent.startTest("Enter ExaminarNationalRegNumber");
		String title1 = driver.getTitle();
		driver.findElement(Examiners_National_RegistoryNo).sendKeys("7"+Random_ExaminarNationalRegNumber());
		Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
	...
	logger = extent.startTest("Enter Limit AbilityToPerformYes");
		...
		Thread.sleep(2000);
		driver.findElement(UploadMedicalCertificate).sendKeys("C:\\Users\\Veeresh Salagar\\Desktop\\Medical Certificate.png");
		Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
...
/*	public void LimitAbilityToPerformNo()
	...
	logger = extent.startTest("Enter Past3YrsEverTestedPositiveYes");
		...
		Thread.sleep(4000);
		driver.findElement(UploadReference_MedicalCertificate).sendKeys("C:\\Users\\Veeresh Salagar\\Desktop\\LOX Carrier Updated Card.png");
		Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
