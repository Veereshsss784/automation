...
public class SubmitDriverApplicationNoReport 
{
...
//-------------------------------------------------------------------------------------------------------------------------    
	...
	public void startReport() {
		extent = new ExtentReports(System.getProperty("user.dir") + "/TestReports/SubmitDriverApplicationAllYes.html", true);
...
//Driver application Login	
	...
	public void Verify_Driver_login() throws InterruptedException, AWTException
	{
		...
		Assert.assertEquals(currentURL, DriverDev);
		driver.manage().window().maximize();
	...
	public void Verify_DriverUN()
	{
		...
		driver.findElement(DrUN).sendKeys("drivere4salagaee"); //=====================================================Username
	...
	public void Verify_DriverPSWD()
	{
		...
		String title1 = driver.getTitle();
		System.out.println(title1);
		driver.findElement(DrPSWD).sendKeys("cKebpZwj9V");  //==================================================Password
		Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
...
/*	@Test(priority=31)
	...
	public void JoiningFromDate() throws InterruptedException
	{
		...
		String title1 = driver.getTitle();
		driver.findElement(ClickFromDate).sendKeys("01022014");
	...
	public void ResignedDate() throws InterruptedException
	{
		...
		String title1 = driver.getTitle();
		driver.findElement(ClickToDate).sendKeys("01022020");
...
//	Form 9. DOT Physical and Medical Certificate
	...
	*/	
	...
	logger = extent.startTest("Enter Medical Certificate ExpDate");
		...
		driver.findElement(Click_Year5).sendKeys("12022023");
	...
	logger = extent.startTest("Enter ExaminarNationalRegNumber");
		String title1 = driver.getTitle();
		driver.findElement(Examiners_National_RegistoryNo).sendKeys("Examinar National Reg Number"+Random_ExaminarNationalRegNumber());
		Assert.assertEquals(title1, "FleetDrive 360 - Smart Compliance Services");
...
*/		
	@Test(priority=58)
	public void Past3YrsEverTestedPositiveNo() throws InterruptedException
	{
	Thread.sleep(2000);
	logger = extent.startTest("Enter Restrictions");
		String title1 = driver.getTitle();
...
// Form 10. Consent Forms	
	...
	logger = extent.startTest("Enter signature");
		...
		Thread.sleep(2000);
		Actions drawaction = act.moveToElement(signatureele, 120, 120);
		drawaction.clickAndHold().moveByOffset(60, 70).release().perform();
		Thread.sleep(2000);  
