...
public class FD360DriverLogin31 {
	...
	public void StartReport() {
		extent = new com.relevantcodes.extentreports.ExtentReports(
				System.getProperty("user.dir") + "/FD360DriverApplnReport/FD360DriverApplSubmitsuraj.html", true);
	...
	public void UserDetails() throws AWTException, InterruptedException {
		...
		Username.sendKeys("suraj1");
		WebElement Password = driver.findElement(By.xpath("//*[@id='password']"));
		Password.sendKeys("C3G04gafqb");
...
/*	@Test(priority=2,enabled=false)
	...
	public void DriverInfo() throws Exception {
		...
		SSNo.sendKeys("784784838");
		WebElement Phone = driver.findElement(By.xpath("//input[@id='phone']"));
		Phone.sendKeys("4042887125");
	...
	public void ResidenceAddressHistory() throws InterruptedException {
		...
		AddressLine1.sendKeys("7101 S CENTRAL AVE LOS ANGELES, CA 90001-9998");

		WebElement AddressLine2 = driver.findElement(By.xpath("//*[@id='driveraddress_20']"));
		AddressLine2.sendKeys("7101 S CENTRAL AVE LOS ANGELES, CA 90001-9998");
		...
		State.click();
		WebElement ele = driver.findElement(By.xpath("//li[.='District Of Columbia']"));
		ele.click();
		...
		NOofYearsInThisAddress.sendKeys("1");
...
/*	 WebElement LicenseNO =driver.findElement(By.xpath("//*[@id='licensedriverLicenseNumber0']"));
	...
	/*	WebElement LicenseClass = driver.findElement(By.xpath("//div[@id='licenselicenseClass0']"));
		...
		Endorsement.sendKeys("special10");
	...
	/*	WebElement IssueDate = driver.findElement(By.xpath("//*[@id='licenseissueDate0']"));
		...
		Restrictions.sendKeys(" NOrestrictions7");
	...
	public void DrivingEquipment() throws Exception {
		...
		commercialDriverExperience.sendKeys("3");
  ...
  Thread.sleep(2000);
		...
		ApproximateNoOfTotalMiles.sendKeys("80001");
	...
	public void EmploymentRecord() throws AWTException, Exception {
		...
		EmployerName.sendKeys("veeresh13");
		WebElement DOTNo = driver.findElement(By.xpath("//input[@id='employment3dot0']"));
		DOTNo.sendKeys("7654385");
		WebElement EmployerPhoneNo = driver.findElement(By.xpath("//input[@id='employment3employerPhone0']"));
		EmployerPhoneNo.sendKeys("4042887126");
		WebElement EmployerEmail = driver.findElement(By.xpath("//input[@id='employment3email0']"));
		EmployerEmail.sendKeys("veeresh4@fleetdrive360.testinator.com");
		WebElement EmployerAddress1 = driver.findElement(By.xpath("//input[@id='employment3address_10']"));
		EmployerAddress1.sendKeys("7101 S CENTRAL AVE LOS ANGELES, CA 90001-9998 United States");
		WebElement EmployerAddress2 = driver.findElement(By.xpath("//input[@id='employment3address_20']"));
		EmployerAddress2.sendKeys("7101 S CENTRAL AVE LOS ANGELES, CA 90001-9998 United States");
		WebElement Employercity = driver.findElement(By.xpath("//input[@id='employment3city']"));
		Employercity.sendKeys("LOS ANGELES");
		WebElement EmployerState = driver.findElement(By.xpath("//div[@id='employment3state']"));
		EmployerState.click();
		WebElement chooseStateAlabama = driver.findElement(By.xpath("//li[.='California']"));
		chooseStateAlabama.click();
		WebElement EmployerZipcode = driver.findElement(By.xpath("//input[@id='employment3zipcode']"));
		EmployerZipcode.sendKeys("90001");
		...
		rbt4.keyPress(KeyEvent.VK_0);
		rbt4.keyRelease(KeyEvent.VK_0);
		rbt4.keyPress(KeyEvent.VK_4);
		rbt4.keyRelease(KeyEvent.VK_4);
		rbt4.keyPress(KeyEvent.VK_0);
		rbt4.keyRelease(KeyEvent.VK_0);
		rbt4.keyPress(KeyEvent.VK_5);
		rbt4.keyRelease(KeyEvent.VK_5);
		rbt4.keyPress(KeyEvent.VK_2);
		rbt4.keyRelease(KeyEvent.VK_2);
		rbt4.keyPress(KeyEvent.VK_0);
		rbt4.keyRelease(KeyEvent.VK_0);
	...
	/*	WebElement SubDOTyes = driver.findElement(By.xpath("//li[@class='MuiButtonBase-root MuiListItem-root MuiMenuItem-root MuiMenuItem-gutters MuiListItem-gutters MuiListItem-button']"));
		...
		ReasonForLeaving.sendKeys("personal problem7");
