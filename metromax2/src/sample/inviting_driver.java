...
//------------------------------------------------------------------------------------------------------------------------------------------------
	...
	public void startReport() {
		extent = new ExtentReports(System.getProperty("user.dir") + "/VS04invite_CDLDriver.html", true);
...
//---------------------------------Testing Started----------------------------------------------------	
	...
	public void printTitle()
	{
		...
		driver.findElement(Username).sendKeys("ellen"); //  oliver_1
		
		driver.findElement(Password).sendKeys("eJroXF8jZ0"); //  AdhEJRXtN9
	...
	@Test(priority=8)
	public void Selecting_Carrier() throws AWTException, InterruptedException 
	{
	...
	public void Invite_new_drivers()
	{
		...
		driver.findElement(Enter_DL_No).sendKeys("VSCDL"+PhoneNo());
	...
	public void ReqCDL_Yes()
	{
		...
		logger.log(LogStatus.PASS, "Choosed Driver Like req Non CDL");
	}   
