...
public class FD360DriverLogin {
	...
	public void StartReport() {
		extent = new com.relevantcodes.extentreports.ExtentReports(
				System.getProperty("user.dir") + "/test-output/FD360DriverLogin2.html", true);
	...
	@Test(priority = 1)
	public void UserDetails() throws AWTException {
		...
		test.log(LogStatus.PASS, "String Url is open in Chrome browser");
		extent.endTest(test);
		extent.flush();
		...
		Username.sendKeys("veereshtestenv");
		WebElement Password = driver.findElement(By.xpath("//*[@id='password']"));
		Password.sendKeys("j3boxeq9KZ");
	...
	@Test(priority = 3)
	public void ResidenceAddressHistory() {
		test.log(LogStatus.INFO, "Filling Basic info of Driver");
...
/*	@Test(priority = 4)
	...
	public void DriverLicenseDetails() throws AWTException, InterruptedException {
		...
		IssueState.click();
		WebElement state = driver.findElement(By.xpath("//li[.='Florida']"));
		state.click();
