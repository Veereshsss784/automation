...
//------------------------------------------------------------------------------------------------------------------------------------------------
	...
	public void startReport() {
		extent = new ExtentReports(System.getProperty("user.dir") + "/TestReports/VS01invite_CDLDriver.html", true);
...
//---------------------------------Testing Started----------------------------------------------------	
	...
	public void OpenedFleetLoginPage() throws InterruptedException, AWTException 
	{
		...
		Assert.assertEquals(currentURL, FleetBeta);
	...
	public void Driver_Info()
	{
		...
		driver.findElement(First_Name).sendKeys("Driver"+MNames());
...
/*	@Test(priority=12)
	...
	{
		logger = extent.startTest("DOB");
		driver.findElement(Driver_DOB).sendKeys(DDOB);
		logger.log(LogStatus.PASS, "Entered Driver DOB");
	}  */
	...
	public void DrEmail()
	{
		...
		driver.findElement(Driver_Email).sendKeys("VSDrEmail"+MNames()+"@innowyze.testinator.com");
...
/*	@Test(priority=15)
	...
	{
		logger = extent.startTest("DrDLIssue_State");
		driver.findElement(Driver_issue_state).click();
		driver.findElement(Selected_State).click();
		logger.log(LogStatus.PASS, "Choosed Driver DL Issue_State");
	}
	
	@Test(priority=16)
	public void ClassType()
	{
		logger = extent.startTest("ClassType");
		driver.findElement(Class_type).click();
		driver.findElement(Choose_Class_NonCDL).click();
		logger.log(LogStatus.PASS, "Choosed Driver DL Class type");
	}
	
	@Test(priority=17)
	public void DL_issueDate()
	{
		logger = extent.startTest("DL_issueDate");
		driver.findElement(License_issue_Date).sendKeys("01022018");
		logger.log(LogStatus.PASS, "Choosed Driver DL Issue_State");
	}
	
	@Test(priority=18)
	public void DL_ExpDate()
	{
		logger = extent.startTest("DL_ExpDate");
		driver.findElement(License_Exp_Date).sendKeys("01022027");
		logger.log(LogStatus.PASS, "Entered DL Expiration date");
	}
	*/
	...
	{
		logger = extent.startTest("ReqCDL_Yes");
		driver.findElement(Requiring_Commercial_DL_YES).click();
		logger.log(LogStatus.PASS, "Choosed Driver req CDL");
	}   
