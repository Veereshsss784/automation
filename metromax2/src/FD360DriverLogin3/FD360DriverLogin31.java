...
public class FD360DriverLogin31 {
	...
	public void StartReport() {
		extent = new com.relevantcodes.extentreports.ExtentReports(
				System.getProperty("user.dir") + "/FD360DriverApplnReport/DriverApplication01.html", true);
	...
	public void UserDetails() throws AWTException, InterruptedException {
		...
		Username.sendKeys("driver441");
		WebElement Password = driver.findElement(By.xpath("//*[@id='password']"));
		Password.sendKeys("l84ZqtRiHm");
	...
	@Test(priority=2,enabled=false)
		public void VerificationOfDriverExistance() throws InterruptedException
		{
		Thread.sleep(3000);
		test = extent.startTest("verify driver is new or existing");
		test.log(LogStatus.INFO, "capturing data and comparing with expected");
		WebElement Status = driver.findElement(By.xpath("//h4[.='Application submitted by Driver ']"));
		String Expected2= Status.getText();
		String Actual2 = "Application submitted by Driver";
		System.out.println(Expected2);
		if (Expected2.equals(Actual2)) {
			test.log(LogStatus.PASS, "Driver Aplication submitted successfully");
			System.out.println("AllReady Driver Aplication submitted successfully..");
			extent.endTest(test);
			driver.quit();
		}
		...
		{     
		      System.out.println("moving forward Execute code");       
		}  
		// Driver Application page
	                                                                                       logger = extent.startTest("Selecting application type");
		Thread.sleep(2000);
	...
	public void DriverInfo() throws Exception {
		...
		WebDriverWait wait=new WebDriverWait(driver,10);
		                                                                                   logger = extent.startTest("Filling Driver information form");
		...
		SSNo.sendKeys("789784789");
		WebElement Phone = driver.findElement(By.xpath("//input[@id='phone']"));
		Phone.sendKeys("4042887111");
	...
	public void ResidenceAddressHistory() throws InterruptedException {
		                                                                                                    logger = extent.startTest("Entering past 3 years of residence address history");
		test.log(LogStatus.INFO, "Filling Basic info of Driver");
         Thread.sleep(3000);
		WebElement AddressLine1 = driver.findElement(By.xpath("//*[@id='driveraddress_10']"));
		AddressLine1.sendKeys("823 CONGRESS AVE STE 150AUSTIN, TX 78701");

		WebElement AddressLine2 = driver.findElement(By.xpath("//*[@id='driveraddress_20']"));
		AddressLine2.sendKeys("823 CONGRESS AVE STE 150AUSTIN, TX 78701");
		...
		State.click();
		WebElement ele = driver.findElement(By.xpath("//li[.='Texas']"));
		ele.click();
		...
		NOofYearsInThisAddress.sendKeys("5");
	...
	public void DriverLicenseDetails() throws AWTException, InterruptedException {
		Thread.sleep(3000);
	                                                                                                   	logger = extent.startTest("Entering Driver License details");
		...
		IssueState.click();
		WebElement state = driver.findElement(By.xpath("//li[.='Texas']"));
		state.click();
...
/*	 WebElement LicenseNO =driver.findElement(By.xpath("//*[@id='licensedriverLicenseNumber0']"));
		...
		WebElement Class = driver.findElement(By.xpath("//li[.='Class A']"));
		Class.click();

		WebElement Endorsement = driver.findElement(By.xpath("//input[@id='licenseendorsement0']"));
		Endorsement.sendKeys("special12");
		...
		rbt1.keyPress(KeyEvent.VK_0);
		rbt1.keyRelease(KeyEvent.VK_0);
		rbt1.keyPress(KeyEvent.VK_5);
		rbt1.keyRelease(KeyEvent.VK_5);
		...
		Restrictions.sendKeys(" noanyrestrictions");
	...
	public void DrivingEquipment() throws Exception {
		                                                                                                        logger = extent.startTest("Entering Driving Equipments info");
		test.log(LogStatus.INFO, "Filling info of DriverLicense");
		...
		commercialDriverExperience.sendKeys("1");
  ...
  Thread.sleep(2000);
		...
		rbt3.keyPress(KeyEvent.VK_1);
		rbt3.keyRelease(KeyEvent.VK_1);
		rbt3.keyPress(KeyEvent.VK_5);
		rbt3.keyRelease(KeyEvent.VK_5);
		...
		ApproximateNoOfTotalMiles.sendKeys("34352");
	...
	public void Accidents() {
		logger = extent.startTest("Entering Driving Equipments info");
		                                                                                                               test.log(LogStatus.INFO, "Selcting if driver done any Accidents");
	...
	public void TrafficVoilations() {
		                                                                                                                logger = extent.startTest("Selecting if Driver done Traffic violations");
	...
	public void AdverseLicensingActions() {
		                                                                                                                   logger = extent.startTest("It is about Driver Adverse Licensing Actions");
	...
	@Test(priority = 10)
	public void EmploymentRecord() throws AWTException, Exception {
		                                                                                                                 logger = extent.startTest("Info about driver Expirience i.e EmploymentRecord");
		test.log(LogStatus.INFO, "Filling info of EmploymentRecord");

	    WebElement AnyEmpHistoryYes = driver.findElement(By.xpath("//input[@id='priorExperienceYes']"));	
	    AnyEmpHistoryYes.click();
		WebElement EmployerName = driver.findElement(By.xpath("//input[@id='employment3employerName0']"));
		EmployerName.sendKeys("veeresh5");
		WebElement DOTNo = driver.findElement(By.xpath("//input[@id='employment3dot0']"));
		DOTNo.sendKeys("9743210");
		WebElement EmployerPhoneNo = driver.findElement(By.xpath("//input[@id='employment3phone0']"));
		EmployerPhoneNo.click();
		EmployerPhoneNo.sendKeys("4042887112");
		WebElement EmployerEmail = driver.findElement(By.xpath("//input[@id='employment3email0']"));
		EmployerEmail.sendKeys("veereshtestit2@gmail.com");
		WebElement EmployerAddress1 = driver.findElement(By.xpath("//input[@id='employment3address_10']"));
		EmployerAddress1.sendKeys("823 CONGRESS AVE STE 150AUSTIN, TX 78701");
		WebElement EmployerAddress2 = driver.findElement(By.xpath("//input[@id='employment3address_20']"));
		EmployerAddress2.sendKeys("823 CONGRESS AVE STE 150AUSTIN, TX 78701");
		WebElement Employercity = driver.findElement(By.xpath("//input[@id='employment3city']"));
		Employercity.sendKeys("austin");
		WebElement EmployerState = driver.findElement(By.xpath("//div[@id='employment3state']"));
		EmployerState.click();
		WebElement chooseStateIndiana = driver.findElement(By.xpath("//li[.='Texas']"));
		chooseStateIndiana.click();
		WebElement EmployerZipcode = driver.findElement(By.xpath("//input[@id='employment3zipcode']"));
		EmployerZipcode.sendKeys("78701");
		WebElement EmployerFromDate = driver.findElement(By.xpath("//input[@id='employment3joiningDate0']"));
		Thread.sleep(3000);
		EmployerFromDate.click();
		Robot rbt3 = new Robot();
		rbt3.keyPress(KeyEvent.VK_0);
		rbt3.keyRelease(KeyEvent.VK_0);
		rbt3.keyPress(KeyEvent.VK_7);
		rbt3.keyRelease(KeyEvent.VK_7);
		rbt3.keyPress(KeyEvent.VK_0);
		rbt3.keyRelease(KeyEvent.VK_0);
		rbt3.keyPress(KeyEvent.VK_2);
		rbt3.keyRelease(KeyEvent.VK_2);
		...
		WebElement EmployerToDate = driver.findElement(By.xpath("//input[@id='employment3releaseDate0']"));
		EmployerToDate.click();
		...
		WebElement PositionHeld = driver.findElement(By.xpath("//input[@id='employment3positionHeld0']"));
		PositionHeld.sendKeys("Driver");
		
		WebElement RateOfpay = driver.findElement(By.xpath("//input[@id='employment3employerSalaryPerLoad0']"));
		RateOfpay.sendKeys("800");
		
		WebElement SubjectedToDOT = driver.findElement(By.xpath("//div[@id='employment3subjectToFmcrs0']"));
		SubjectedToDOT.click();
		Thread.sleep(2000);
		WebElement Yes = driver.findElement(By.xpath("//li[@class='MuiButtonBase-root MuiListItem-root MuiMenuItem-root MuiMenuItem-gutters MuiListItem-gutters MuiListItem-button']"));
		Yes.click();
	//	WebElement No = driver.findElement(By.xpath("(//li[@class='MuiButtonBase-root MuiListItem-root MuiMenuItem-root MuiMenuItem-gutters MuiListItem-gutters MuiListItem-button'])[2]"));
		Thread.sleep(2000);
		WebElement SubjectedToDOTDrugAnaAlcoholTesting= driver.findElement(By.xpath("(//div[@class='MuiSelect-root MuiSelect-select MuiSelect-selectMenu MuiSelect-outlined MuiInputBase-input MuiOutlinedInput-input'])[3]"));
		SubjectedToDOTDrugAnaAlcoholTesting.click();
		
		Robot rbt5 = new Robot();
		rbt5.keyPress(KeyEvent.VK_ENTER);  
		rbt5.keyRelease(KeyEvent.VK_ENTER);
	/*	WebElement SubDOTyes = driver.findElement(By.xpath("//li[@class='MuiButtonBase-root MuiListItem-root MuiMenuItem-root MuiMenuItem-gutters MuiListItem-gutters MuiListItem-button']"));
		SubDOTyes.click();  */
		WebElement ReasonForLeaving = driver.findElement(By.xpath("//input[@id='employment3leavingReason0']"));
		ReasonForLeaving.sendKeys("personal problem");
		
		WebElement OtherEmpltHitoryNo = driver.findElement(By.xpath("//input[@id='priorExperience10YearNo']"));
		OtherEmpltHitoryNo.click();
	...
	public void PhysicalHistory() throws InterruptedException, AWTException {
		                                                                                                                    logger = extent.startTest("Entering info about Driver Physical History");
	...
	public void ConsentForm() throws InterruptedException, AWTException {
		                                                                                                                    logger = extent.startTest("Checking Driver conformation for all Consent Form");
		test.log(LogStatus.INFO, "conformation for all Consent Form");
		...
		Assert.assertTrue(true);
		test.log(LogStatus.PASS, "To Be Read And Signed By Applicant form submitted successfully");
		System.out.println(" To Be Read And Signed By Applicant form submitted successfully");
